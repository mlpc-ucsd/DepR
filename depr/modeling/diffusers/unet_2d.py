...
from .unet_2d_blocks import get_down_block, get_up_block, Conv3DAwareUNetMidBlock2D
from ..utils.conv import GroupConv


class Conv3DAwareUNet(ModelMixin, ConfigMixin):
    r"""
    ...
    def __init__(
        ...
        # mid
        self.mid_block = Conv3DAwareUNetMidBlock2D(
